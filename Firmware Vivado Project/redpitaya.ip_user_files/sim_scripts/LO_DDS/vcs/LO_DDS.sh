...
#
# Generated by Vivado on Mon Aug 08 13:27:30 EDT 2016
# IP Build 1412160 on Tue Nov 17 13:47:24 MST 2015 
#
# usage: LO_DDS.sh [-help]
# usage: LO_DDS.sh [-lib_map_path]
# usage: LO_DDS.sh [-noclean_files]
# usage: LO_DDS.sh [-reset_run]
#
...
# executing this script. Please type 'LO_DDS.sh -help' for more information.
#
...
# Script info
echo -e "LO_DDS.sh - Script generated by export_simulation (Vivado v2015.4 (64-bit)-id)\n"

# Script usage
usage()
{
  msg="Usage: LO_DDS.sh [-help]\n\
Usage: LO_DDS.sh [-lib_map_path]\n\
Usage: LO_DDS.sh [-reset_run]\n\
Usage: LO_DDS.sh [-noclean_files]\n\n\
...
if [[ ($# == 1 ) && ($1 != "-lib_map_path" && $1 != "-noclean_files" && $1 != "-reset_run" && $1 != "-help" && $1 != "-h") ]]; then
  echo -e "ERROR: Unknown option specified '$1' (type \"./LO_DDS.sh -help\" for more information)\n"
  exit 1
fi
...
setup()
{
  case $1 in
    "-lib_map_path" )
      if [[ ($2 == "") ]]; then
        echo -e "ERROR: Simulation library directory path not specified (type \"./LO_DDS.sh -help\" for more information)\n"
        exit 1
      fi
...
reset_run()
{
  files_to_remove=(ucli.key LO_DDS_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log 64 AN.DB csrc LO_DDS_simv.daidir)
...
compile()
{
  ...
  vhdlan -work xil_defaultlib $opts_vhd \
    "$ref_dir/../../../ip/LO_DDS/sim/LO_DDS.vhd" \
  2>&1 | tee -a vhdlan.log
...
elaborate()
{
  ...
  vcs $opts xil_defaultlib.LO_DDS -o LO_DDS_simv
}
...
simulate()
{
  ...
  ./LO_DDS_simv $opts -do simulate.do
}
# Script usage
usage()
{
