...
#
# Generated by Vivado on Wed Aug 09 10:48:24 -0400 2017
...
# Script info
echo -e "clk_10MHz_sync.sh - Script generated by export_simulation (Vivado v2015.4 (64-bit)-id)\n"
...
if [[ ($# == 1 ) && ($1 != "-lib_map_path" && $1 != "-noclean_files" && $1 != "-reset_run" && $1 != "-help" && $1 != "-h") ]]; then
  echo -e "ERROR: Unknown option specified '$1' (type \"./clk_10MHz_sync.sh -help\" for more information)\n"
  exit 1
fi
...
elaborate()
{
  ...
  libs="-libname unisims_ver -libname unimacro_ver -libname secureip -libname work"
  ncelab $opts work.clk_10MHz_sync work.glbl $libs
}
...
simulate()
{
  ...
  ncsim $opts work.clk_10MHz_sync -input simulate.do
}
# Script usage
usage()
{
