...
#
# Generated by Vivado on Sun Aug 14 20:16:43 EDT 2016
...
compile()
{
  ...
  ncvhdl -work work $opts_vhd \
    "$ref_dir/../../../../redpitaya.srcs/sources_1/ip/fifo_generator_0/sim/fifo_generator_0.vhd" \
...
elaborate()
{
  ...
  ncelab $opts work.fifo_generator_0 $libs
}
...
simulate()
{
  ...
  ncsim $opts work.fifo_generator_0 -input simulate.do
}
# Script usage
usage()
{
