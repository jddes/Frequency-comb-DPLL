...
HD_PWD='C:/Users/Alex/Documents/GitHub/OnlineVersion2/Firmware Vivado Project/redpitaya.runs/clk_10MHz_sync_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log clk_10MHz_sync.vds -m64 -mode batch -messageDb vivado.pb -notrace -source clk_10MHz_sync.tcl
