...
HD_PWD='D:/Users/Alex/Documents/GitHub/Frequency-comb-DPLL_v2/Frequency-comb-DPLL-DPLL-python3/Firmware Vivado Project/redpitaya.runs/input_multiplier_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log input_multiplier.vds -m64 -mode batch -messageDb vivado.pb -notrace -source input_multiplier.tcl
