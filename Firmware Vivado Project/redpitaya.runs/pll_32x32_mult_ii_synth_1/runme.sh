...
HD_PWD='D:/Users/Alex/Documents/GitHub/Frequency-comb-DPLL_v2/Frequency-comb-DPLL-DPLL-python3/Firmware Vivado Project/redpitaya.runs/pll_32x32_mult_ii_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pll_32x32_mult_ii.vds -m64 -mode batch -messageDb vivado.pb -notrace -source pll_32x32_mult_ii.tcl
