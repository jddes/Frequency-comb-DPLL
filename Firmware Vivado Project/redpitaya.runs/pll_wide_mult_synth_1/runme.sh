...
HD_PWD='D:/Users/Alex/Documents/GitHub/Frequency-comb-DPLL_v2/Frequency-comb-DPLL-DPLL-python3/Firmware Vivado Project/redpitaya.runs/pll_wide_mult_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pll_wide_mult.vds -m64 -mode batch -messageDb vivado.pb -notrace -source pll_wide_mult.tcl
