...
#
# Generated by export_simulation on Tue Jul 04 16:21:13 -0400 2017
#
################################################################################
...
switch to the './FIFO_addr_packed.sh' script.

./FIFO_addr_packed.sh -reset_run
...
./FIFO_addr_packed.sh -noclean_files

For more information on the script, please type './FIFO_addr_packed.sh -help'.
