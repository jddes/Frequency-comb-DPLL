...
#
# Generated by Vivado on Tue Jan 09 20:16:02 -0500 2018
# IP Build 1412160 on Tue Nov 17 13:47:24 MST 2015 
#
# usage: Ref_generator_DDS.sh [-help]
# usage: Ref_generator_DDS.sh [-lib_map_path]
# usage: Ref_generator_DDS.sh [-noclean_files]
# usage: Ref_generator_DDS.sh [-reset_run]
#
...
# executing this script. Please type 'Ref_generator_DDS.sh -help' for more information.
#
...
# Script info
echo -e "Ref_generator_DDS.sh - Script generated by export_simulation (Vivado v2015.4 (64-bit)-id)\n"

# Script usage
usage()
{
  msg="Usage: Ref_generator_DDS.sh [-help]\n\
Usage: Ref_generator_DDS.sh [-lib_map_path]\n\
Usage: Ref_generator_DDS.sh [-reset_run]\n\
Usage: Ref_generator_DDS.sh [-noclean_files]\n\n\
...
if [[ ($# == 1 ) && ($1 != "-lib_map_path" && $1 != "-noclean_files" && $1 != "-reset_run" && $1 != "-help" && $1 != "-h") ]]; then
  echo -e "ERROR: Unknown option specified '$1' (type \"./Ref_generator_DDS.sh -help\" for more information)\n"
  exit 1
fi
...
setup()
{
  case $1 in
    "-lib_map_path" )
      if [[ ($2 == "") ]]; then
        echo -e "ERROR: Simulation library directory path not specified (type \"./Ref_generator_DDS.sh -help\" for more information)\n"
        exit 1
      fi
...
compile()
{
  ...
  ncvhdl -work work $opts_vhd \
    "$ref_dir/../../../../redpitaya.srcs/sources_1/ip/Ref_generator_DDS/sim/Ref_generator_DDS.vhd" \
...
elaborate()
{
  ...
  ncelab $opts work.Ref_generator_DDS $libs
}
...
simulate()
{
  ...
  ncsim $opts work.Ref_generator_DDS -input simulate.do
}
# Script usage
usage()
{
