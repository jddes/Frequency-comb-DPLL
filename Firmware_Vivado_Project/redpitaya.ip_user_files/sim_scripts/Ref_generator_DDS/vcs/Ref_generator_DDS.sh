...
reset_run()
{
  files_to_remove=(ucli.key Ref_generator_DDS_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log 64 AN.DB csrc Ref_generator_DDS_simv.daidir)
...
elaborate()
{
  ...
  vcs $opts work.Ref_generator_DDS -o Ref_generator_DDS_simv
}
...
simulate()
{
  ...
  ./Ref_generator_DDS_simv $opts -do simulate.do
}
# Script usage
usage()
{
