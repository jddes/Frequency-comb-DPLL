...
#
# Filename    : Ref_generator_DDS_2.sh
...
#
# Generated by Vivado on Tue Jan 09 20:59:09 -0500 2018
# IP Build 1412160 on Tue Nov 17 13:47:24 MST 2015 
#
# usage: Ref_generator_DDS_2.sh [-help]
# usage: Ref_generator_DDS_2.sh [-lib_map_path]
# usage: Ref_generator_DDS_2.sh [-noclean_files]
# usage: Ref_generator_DDS_2.sh [-reset_run]
#
...
# executing this script. Please type 'Ref_generator_DDS_2.sh -help' for more information.
#
...
# Script info
echo -e "Ref_generator_DDS_2.sh - Script generated by export_simulation (Vivado v2015.4 (64-bit)-id)\n"

# Script usage
usage()
{
  msg="Usage: Ref_generator_DDS_2.sh [-help]\n\
Usage: Ref_generator_DDS_2.sh [-lib_map_path]\n\
Usage: Ref_generator_DDS_2.sh [-reset_run]\n\
Usage: Ref_generator_DDS_2.sh [-noclean_files]\n\n\
...
if [[ ($# == 1 ) && ($1 != "-lib_map_path" && $1 != "-noclean_files" && $1 != "-reset_run" && $1 != "-help" && $1 != "-h") ]]; then
  echo -e "ERROR: Unknown option specified '$1' (type \"./Ref_generator_DDS_2.sh -help\" for more information)\n"
  exit 1
fi
...
setup()
{
  case $1 in
    "-lib_map_path" )
      if [[ ($2 == "") ]]; then
        echo -e "ERROR: Simulation library directory path not specified (type \"./Ref_generator_DDS_2.sh -help\" for more information)\n"
        exit 1
      fi
...
create_lib_mappings()
{
  libs=(xbip_utils_v3_0_5 axi_utils_v2_0_1 xbip_pipe_v3_0_1 xbip_bram18k_v3_0_1 mult_gen_v12_0_10 xbip_dsp48_wrapper_v3_0_4 xbip_dsp48_addsub_v3_0_1 xbip_dsp48_multadd_v3_0_1 dds_compiler_v6_0_11 work)
  file="cds.lib"
  dir="ies"
...
compile()
{
  ...
  ncvhdl -work work $opts_vhd \
    "$ref_dir/../../../../redpitaya.srcs/sources_1/ip/Ref_generator_DDS_2/sim/Ref_generator_DDS_2.vhd" \
...
elaborate()
{
  ...
  libs="-libname secureip -libname xbip_utils_v3_0_5 -libname axi_utils_v2_0_1 -libname xbip_pipe_v3_0_1 -libname xbip_bram18k_v3_0_1 -libname mult_gen_v12_0_10 -libname xbip_dsp48_wrapper_v3_0_4 -libname xbip_dsp48_addsub_v3_0_1 -libname xbip_dsp48_multadd_v3_0_1 -libname dds_compiler_v6_0_11 -libname work"
  ncelab $opts work.Ref_generator_DDS_2 $libs
}
...
simulate()
{
  ...
  ncsim $opts work.Ref_generator_DDS_2 -input simulate.do
}
# Script usage
usage()
{
