...
reset_run()
{
  files_to_remove=(ucli.key Ref_generator_DDS_2_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log 64 AN.DB csrc Ref_generator_DDS_2_simv.daidir)
...
create_lib_mappings()
{
  libs=(xbip_utils_v3_0_5 axi_utils_v2_0_1 xbip_pipe_v3_0_1 xbip_bram18k_v3_0_1 mult_gen_v12_0_10 xbip_dsp48_wrapper_v3_0_4 xbip_dsp48_addsub_v3_0_1 xbip_dsp48_multadd_v3_0_1 dds_compiler_v6_0_11)
...
elaborate()
{
  ...
  vcs $opts work.Ref_generator_DDS_2 -o Ref_generator_DDS_2_simv
}
...
simulate()
{
  ...
  ./Ref_generator_DDS_2_simv $opts -do simulate.do
}
# Script usage
usage()
{
