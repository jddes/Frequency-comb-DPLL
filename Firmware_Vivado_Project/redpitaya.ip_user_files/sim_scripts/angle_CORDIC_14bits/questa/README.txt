...
#
# Generated by export_simulation on Tue Jan 09 19:17:30 -0500 2018
#
################################################################################
...
switch to the './angle_CORDIC_14bits.sh' script.

./angle_CORDIC_14bits.sh -reset_run
...
./angle_CORDIC_14bits.sh -noclean_files

For more information on the script, please type './angle_CORDIC_14bits.sh -help'.
