...
create_lib_mappings()
{
  libs=(xbip_utils_v3_0_5 axi_utils_v2_0_1 xbip_pipe_v3_0_1 xbip_bram18k_v3_0_1 mult_gen_v12_0_10 cmpy_v6_0_10 work)
  file="cds.lib"
  dir="ies"
...
elaborate()
{
  ...
  libs="-libname secureip -libname xbip_utils_v3_0_5 -libname axi_utils_v2_0_1 -libname xbip_pipe_v3_0_1 -libname xbip_bram18k_v3_0_1 -libname mult_gen_v12_0_10 -libname cmpy_v6_0_10 -libname work"
  ncelab $opts work.complex_mult_16x16 $libs
}
...
simulate()
{
  ...
  ncsim $opts work.complex_mult_16x16 -input simulate.do
}
# Script usage
usage()
{
