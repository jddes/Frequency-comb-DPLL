...
HD_PWD='D:/Repo/Frequency-comb-DPLL/Firmware_Vivado_Project/redpitaya.runs/Ref_generator_DDS_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Ref_generator_DDS_2.vds -m64 -mode batch -messageDb vivado.pb -notrace -source Ref_generator_DDS_2.tcl
