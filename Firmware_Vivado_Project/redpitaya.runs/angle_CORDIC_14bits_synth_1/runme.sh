...
HD_PWD='D:/Repo/Frequency-comb-DPLL/Firmware_Vivado_Project/redpitaya.runs/angle_CORDIC_14bits_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log angle_CORDIC_14bits.vds -m64 -mode batch -messageDb vivado.pb -notrace -source angle_CORDIC_14bits.tcl
