...
HD_PWD='D:/Repo/Frequency-comb-DPLL/Firmware_Vivado_Project/redpitaya.runs/angle_CORDIC_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log angle_CORDIC.vds -m64 -mode batch -messageDb vivado.pb -notrace -source angle_CORDIC.tcl
