...
HD_PWD='D:/Repo/Frequency-comb-DPLL/Firmware_Vivado_Project/redpitaya.runs/complex_mult_16x16_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log complex_mult_16x16.vds -m64 -mode batch -messageDb vivado.pb -notrace -source complex_mult_16x16.tcl
