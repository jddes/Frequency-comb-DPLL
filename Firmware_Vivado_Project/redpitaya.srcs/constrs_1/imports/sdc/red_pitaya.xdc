...
set_property PACKAGE_PIN G17 [get_ports DIO0_P]
...
set_property PACKAGE_PIN H18 [get_ports DIO2_N]
set_property PACKAGE_PIN K17 [get_ports DIO3_P]
set_property PACKAGE_PIN K18 [get_ports DIO3_N]
set_property PACKAGE_PIN L14 [get_ports DIO4_P]
set_property PACKAGE_PIN L15 [get_ports DIO4_N]
set_property PACKAGE_PIN L16 [get_ports DIO5_P]
set_property PACKAGE_PIN L17 [get_ports DIO5_N]
set_property PACKAGE_PIN K16 [get_ports DIO6_P]
set_property PACKAGE_PIN J16 [get_ports DIO6_N]
set_property PACKAGE_PIN M14 [get_ports DIO7_P]
set_property PACKAGE_PIN M15 [get_ports DIO7_N]
...
create_clock -period 5.000 -name ext_clk [get_ports DIO5_P]

# set_false_path -from [get_cells counter_gray_target] -to [get_cells counter_gray_ref_reg1]
set_max_delay -datapath_only -from [get_clocks clk_fpga_3] -to [get_clocks ext_clk] 3.000
...
connect_debug_port u_ila_0/probe0 [get_nets [list AD9912_SPI_CSB]]
create_debug_port u_ila_0 probe
set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0/probe1]
set_property port_width 1 [get_debug_ports u_ila_0/probe1]
connect_debug_port u_ila_0/probe1 [get_nets [list AD9912_SPI_SCLK]]
create_debug_port u_ila_0 probe
set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0/probe2]
set_property port_width 1 [get_debug_ports u_ila_0/probe2]
connect_debug_port u_ila_0/probe2 [get_nets [list AD9912_SPI_SCLK_N]]
create_debug_port u_ila_0 probe
set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0/probe3]
set_property port_width 1 [get_debug_ports u_ila_0/probe3]
connect_debug_port u_ila_0/probe3 [get_nets [list AD9912_SPI_SCLK_P]]
create_debug_port u_ila_0 probe
set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0/probe4]
set_property port_width 1 [get_debug_ports u_ila_0/probe4]
connect_debug_port u_ila_0/probe4 [get_nets [list AD9912_SPI_SDIO1]]
