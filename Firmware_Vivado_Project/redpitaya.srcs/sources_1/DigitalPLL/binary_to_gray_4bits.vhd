...
architecture Behavioral of binary_to_gray_4bits is
    ...
    begin
        if rising_edge(clk) then
            case data_in is
                ...
                when b"0100" => data_out_reg <= b"0110";
                when b"0101" => data_out_reg <= b"0111";
                when b"0110" => data_out_reg <= b"0101";
                when b"0111" => data_out_reg <= b"0100";
                when b"1000" => data_out_reg <= b"1100";
                when b"1001" => data_out_reg <= b"1101";
                when b"1010" => data_out_reg <= b"1111";
                when b"1011" => data_out_reg <= b"1110";
                when b"1100" => data_out_reg <= b"1010";
                when b"1101" => data_out_reg <= b"1011";
                when b"1110" => data_out_reg <= b"1001";
                when b"1111" => data_out_reg <= b"1000";
