...
wire pll0_lock_register, pll0_lock_on_next_trigger;
wire [32-1:0] pll0_lock_on_trigger_delay;
...
parallel_bus_register_pll0_settings (
    ...
    .bus_address(cmd_addr), 
    .bus_data({cmd_data2in, cmd_data1in}), 
    .register_output(pll0_lock_register), 
    .update_flag()
    );
...
parallel_bus_register_pll0_locktrigger (
    .clk(clk1), 
    .bus_strobe(cmd_trig), 
    .bus_address(cmd_addr), 
    .bus_data({cmd_data2in, cmd_data1in}), 
    .register_output(pll0_lock_on_next_trigger), 
    .update_flag()
    );
...
parallel_bus_register_pll0_locktrigger_delay (
    .clk(clk1), 
    .bus_strobe(cmd_trig), 
    .bus_address(cmd_addr), 
    .bus_data({cmd_data2in, cmd_data1in}), 
    .register_output(pll0_lock_on_trigger_delay), 
    .update_flag()
    );
    ...
    .delay_before_lock(pll0_lock_on_trigger_delay),
...
wire pll1_lock_register, pll1_lock_on_next_trigger;
wire [32-1:0] pll1_lock_on_trigger_delay;
...
parallel_bus_register_pll1_settings (
    ...
    .bus_address(cmd_addr), 
    .bus_data({cmd_data2in, cmd_data1in}), 
    .register_output(pll1_lock_register), 
    .update_flag()
    );
...
parallel_bus_register_pll1_locktrigger (
    .clk(clk1), 
    .bus_strobe(cmd_trig), 
    .bus_address(cmd_addr), 
    .bus_data({cmd_data2in, cmd_data1in}), 
    .register_output(pll1_lock_on_next_trigger), 
    .update_flag()
    );
...
parallel_bus_register_pll1_locktrigger_delay (
    .clk(clk1), 
    .bus_strobe(cmd_trig), 
    .bus_address(cmd_addr), 
    .bus_data({cmd_data2in, cmd_data1in}), 
...
parallel_bus_register_output_trigger (
    ...
    .delay_before_lock(pll1_lock_on_trigger_delay),
    .bLock_manual(pll1_lock_register),
    .lock_output(pll1_lock)
    );
